...
public class Register extends JFrame implements ActionListener {
    ...
    Register(){
        ...
        int x = fm.stringWidth("STATE BANK OF INDIA ");
        ...
        l1.setFont(new Font("Aerial", Font.BOLD, 38));

        l2 = new JLabel(" Personal Details :");
        l2.setFont(new Font("Aerial", Font.BOLD, 22));
        ...
        l12.setFont(new Font("Aerial", Font.BOLD, 20));

        l13 = new JLabel("Date");
        l13.setFont(new Font("Aerial", Font.BOLD, 14));

        l14 = new JLabel("Month");
        l14.setFont(new Font("Aerial", Font.BOLD, 14));

        l15 = new JLabel("Year");
        l15.setFont(new Font("Aerial", Font.BOLD, 14));


        t1 = new JTextField();
        t1.setFont(new Font("Aerial", Font.BOLD, 14));

        t2 = new JTextField();
        t2.setFont(new Font("Aerial", Font.BOLD, 14));

        t3 = new JTextField();
        t3.setFont(new Font("Aerial", Font.BOLD, 14));

        t4 = new JTextField();
        t4.setFont(new Font("Aerial", Font.BOLD, 14));

        t5 = new JTextField();
        t5.setFont(new Font("Aerial", Font.BOLD, 14));

        t6 = new JTextField();
        t6.setFont(new Font("Aerial", Font.BOLD, 14));

        t7 = new JTextField();
        t7.setFont(new Font("Aerial", Font.BOLD, 14));



        b = new JButton("Next");
        b.setFont(new Font("Aerial", Font.BOLD, 14));
        ...
        r4.setFont(new Font("Aerial", Font.BOLD, 14));
        r4.setBackground(Color.WHITE);

        r5 = new JRadioButton("Other");
        r5.setFont(new Font("Aerial", Font.BOLD, 14));
